...
/***/ "./src/services/LoadingOrErrorStateUIManager.ts":
/*!******************************************************!*\
  !*** ./src/services/LoadingOrErrorStateUIManager.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_isHTMLElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/isHTMLElement */ \"./src/utils/isHTMLElement.ts\");\n/* harmony import */ var _components_Skeleton_Skeleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Skeleton/Skeleton */ \"./src/components/Skeleton/Skeleton.ts\");\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api */ \"./src/api/index.ts\");\n/* harmony import */ var _utils_removeHTMLElements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/removeHTMLElements */ \"./src/utils/removeHTMLElements.ts\");\n/* harmony import */ var _components_ShowMoreButton_eventHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/ShowMoreButton/eventHandler */ \"./src/components/ShowMoreButton/eventHandler.ts\");\n/* harmony import */ var _utils_createElement__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/createElement */ \"./src/utils/createElement.ts\");\n/* harmony import */ var _components_ErrorComponent_ErrorComponent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ErrorComponent/ErrorComponent */ \"./src/components/ErrorComponent/ErrorComponent.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (undefined && undefined.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (g && (g = 0, op[0] && (_ = 0)), _) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\n\n\n\n\n\n\n\nvar LoadingOrErrorStateUIManager = (function () {\n    function LoadingOrErrorStateUIManager(api) {\n        this.SKELETON_LENGTH = 8;\n        this.isLoading = false;\n        this.api = api;\n    }\n    LoadingOrErrorStateUIManager.prototype.showErrorComponent = function (errorComponent) {\n        var main = document.querySelector('main');\n        if (!(0,_utils_isHTMLElement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(main))\n            return;\n        main.innerHTML = '';\n        main.appendChild(errorComponent);\n    };\n    LoadingOrErrorStateUIManager.prototype.onErrorChanged = function (error) {\n        if (error) {\n            var errorComponent = (0,_components_ErrorComponent_ErrorComponent__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(error.status);\n            this.showErrorComponent(errorComponent);\n        }\n    };\n    LoadingOrErrorStateUIManager.prototype.fetchData = function (url, _a) {\n        var _b = _a.method, method = _b === void 0 ? 'GET' : _b, _c = _a.body, body = _c === void 0 ? null : _c, _d = _a.headers, headers = _d === void 0 ? {} : _d;\n        return __awaiter(this, void 0, void 0, function () {\n            var data, error_1;\n            return __generator(this, function (_e) {\n                switch (_e.label) {\n                    case 0:\n                        _e.trys.push([0, 2, , 3]);\n                        this.isLoading = true;\n                        this.onLoadingChanged();\n                        return [4, this.api.sendRequest(url, { method: method, body: body, headers: headers })];\n                    case 1:\n                        data = _e.sent();\n                        this.checkExistingData(data.results.length);\n                        this.isLoading = false;\n                        this.resetMovieList();\n                        return [2, data];\n                    case 2:\n                        error_1 = _e.sent();\n                        if (error_1) {\n                            this.resetMovieList();\n                            this.onErrorChanged(error_1);\n                        }\n                        return [3, 3];\n                    case 3: return [2];\n                }\n            });\n        });\n    };\n    LoadingOrErrorStateUIManager.prototype.checkExistingData = function (length) {\n        (0,_utils_removeHTMLElements__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('.error-text');\n        if (!length) {\n            (0,_components_ShowMoreButton_eventHandler__WEBPACK_IMPORTED_MODULE_4__.checkDataLength)(length);\n            var section = document.querySelector('.item-view');\n            if (!section)\n                return;\n            var errorText = (0,_utils_createElement__WEBPACK_IMPORTED_MODULE_5__[\"default\"])('p', { textContent: '검색 결과가 존재하지 않습니다', className: 'error-text' });\n            section.appendChild(errorText);\n        }\n    };\n    LoadingOrErrorStateUIManager.prototype.resetMovieList = function () {\n        if (!this.isLoading) {\n            (0,_utils_removeHTMLElements__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('.skeleton');\n        }\n    };\n    LoadingOrErrorStateUIManager.prototype.createSkeleton = function () {\n        var fragment = document.createDocumentFragment();\n        Array.from({ length: this.SKELETON_LENGTH }, function () {\n            var skeleton = (0,_components_Skeleton_Skeleton__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n            fragment.appendChild(skeleton);\n        });\n        return fragment;\n    };\n    LoadingOrErrorStateUIManager.prototype.onLoadingChanged = function () {\n        var ul = document.querySelector('ul');\n        if ((0,_utils_isHTMLElement__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(ul) && this.isLoading) {\n            var skeletonComponent = this.createSkeleton();\n            ul.appendChild(skeletonComponent);\n        }\n    };\n    return LoadingOrErrorStateUIManager;\n}());\nvar loadingOrErrorStateUIManager = new LoadingOrErrorStateUIManager(_api__WEBPACK_IMPORTED_MODULE_2__.api);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loadingOrErrorStateUIManager);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/services/LoadingOrErrorStateUIManager.ts?");
...
/***/ "./src/services/getMovieListByKeywordAndUpdatedPageNumber.ts":
/*!*******************************************************************!*\
  !*** ./src/services/getMovieListByKeywordAndUpdatedPageNumber.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _components_ShowMoreButton_eventHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/ShowMoreButton/eventHandler */ \"./src/components/ShowMoreButton/eventHandler.ts\");\n/* harmony import */ var _PageManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PageManager */ \"./src/services/PageManager.ts\");\n/* harmony import */ var _LoadingOrErrorStateUIManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LoadingOrErrorStateUIManager */ \"./src/services/LoadingOrErrorStateUIManager.ts\");\n/* harmony import */ var _constants_api_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants/api/api */ \"./src/constants/api/api.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (undefined && undefined.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (g && (g = 0, op[0] && (_ = 0)), _) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\n\n\n\n\nvar getMovieListByKeywordAndUpdatedPageNumber = function (keyword, option) { return __awaiter(void 0, void 0, void 0, function () {\n    var updatePageNumber, totalUrl, data, results;\n    return __generator(this, function (_a) {\n        switch (_a.label) {\n            case 0:\n                updatePageNumber = _PageManager__WEBPACK_IMPORTED_MODULE_1__[\"default\"].increasePage();\n                totalUrl = (0,_components_ShowMoreButton_eventHandler__WEBPACK_IMPORTED_MODULE_0__.getTotalApiUrl)(option, keyword, updatePageNumber);\n                return [4, _LoadingOrErrorStateUIManager__WEBPACK_IMPORTED_MODULE_2__[\"default\"].fetchData(totalUrl, { headers: _constants_api_api__WEBPACK_IMPORTED_MODULE_3__.API_OPTION.headers })];\n            case 1:\n                data = _a.sent();\n                results = data.results;\n                return [2, results];\n        }\n    });\n}); };\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getMovieListByKeywordAndUpdatedPageNumber);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/services/getMovieListByKeywordAndUpdatedPageNumber.ts?");
